...
static const TasasPriv PRIV[9] = {
  /*sin_agua*/         {{0.12,0.06,0.025,0.005,0.00,0.00},{0.40,0.26,0.10,0.035,0.01,0.00}},
  /*sin_excretas*/     {{0.14,0.07,0.025,0.005,0.00,0.00},{0.43,0.28,0.10,0.035,0.01,0.00}},
  /*piso_inadec*/      {{0.12,0.06,0.012,0.005,0.00,0.00},{0.30,0.17,0.05,0.015,0.00,0.00}},
  /*pared_inadec*/     {{0.06,0.025,0.006,0.00,0.00,0.00},{0.13,0.065,0.018,0.00,0.00,0.00}},
  /*hacinamiento*/     {{0.25,0.14,0.06,0.025,0.006,0.00},{0.25,0.16,0.07,0.025,0.01,0.00}},
  /*sin_internet*/     {{0.55,0.34,0.17,0.06,0.02,0.00},{0.72,0.56,0.34,0.17,0.07,0.02}},
  /*barrera_priminf*/  {{0.18,0.11,0.055,0.022,0.01,0.00},{0.28,0.19,0.085,0.035,0.01,0.00}},
  /*trabajo_infantil*/ {{0.045,0.022,0.011,0.005,0.00,0.00},{0.10,0.06,0.025,0.01,0.00,0.00}},
  /*barrera_salud*/    {{0.11,0.08,0.055,0.032,0.02,0.01},{0.16,0.11,0.065,0.035,0.02,0.01}},
};
